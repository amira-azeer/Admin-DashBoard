...
import { Link } from "react-router-dom"; // Navigates to the page you click on
...
const Item = ({ title, to, icon, selected, setSelected }) => {
    ...
    return (
        <MenuItem active={selected === title} style={{ color: colours.grey[100] }} onClick={() => setSelected(title)} icon={icon}>
...
const SideBar = () => {
    ...
    return (
        <Box sx={{
            "& .pro-sidebar-inner": {
                background: `${colours.primary[400]} !important` // Important tag overrides all specific styling for the property as this is coming from a library
            },
            "& .pro-icon-wrapper": {
                backgroundColor: "transparent !important"
            },
            "& .pro-inner-item": {
                padding: "5px 35px 5px 20px !important" // top, right, bottom, left
            },
            ...
            <ProSidebar collapsed={isCollapsed}>
                <Menu iconShape="square">
                    ...
                    {!isCollapsed && (
                        <Box mb="25px">
                            ...
                            <Box textAlign="center">
                                <Typography variant="h2" color={colours.grey[100]} fontWeight="bold" sx={{ m:"10px 0 0 0", }}>Amira Azeer</Typography>
                                <Typography variant="h5" color={colours.greenAccent[500]}>VP Admin</Typography>
                    ...
                    <Box paddingLeft={isCollapsed ? undefined : "10%"}>
                        ...
                        <Typography variant="h6" color={colours.grey[300]} sx={{ m:"15px 0 5px 20px" }}>Data</Typography>
                        ...
                        <Typography variant="h6" color={colours.grey[300]} sx={{ m:"15px 0 5px 20px" }}>Pages</Typography>
                        ...
                        <Typography variant="h6" color={colours.grey[300]} sx={{ m:"15px 0 5px 20px" }}>Charts</Typography>
